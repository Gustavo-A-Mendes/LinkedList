...
int main() {
    Lista2 *lista = lst2_cria();  // Cria uma lista encadeada vazia

    // Insere elementos na lista
    lista = lst2_insere(lista, 42);
    lista = lst2_insere(lista, 17);
    lista = lst2_insere(lista, 65);
    lista = lst2_insere(lista, 23);
